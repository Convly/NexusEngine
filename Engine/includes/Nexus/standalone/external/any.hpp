//
// Implementation of N4562 external::any (merged into C++17) for C++11 compilers.
//
// See also:
...
//
#ifndef NEXUS_ENGINE_EXTERNAL_ANY_HPP_
#define NEXUS_ENGINE_EXTERNAL_ANY_HPP_
#pragma once
#include <typeinfo>
#include <type_traits>
#include <stdexcept>
...
namespace std
{
    inline void swap(external::any& lhs, external::any& rhs) noexcept
    {
        lhs.swap(rhs);
    }
}
