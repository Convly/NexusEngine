...
void FrameworkScript::registerEnv() {
    luabridge::getGlobalNamespace(_state)
            ...
            //.addConstructor<void(*)(const nx::env::GUIElementInfos&)>()
            .addData("pos", &nx::env::GUIElementInfos::pos)
            .addData("size", &nx::env::GUIElementInfos::size)
            .addData("identifier", &nx::env::GUIElementInfos::identifier)
            .endClass()
            ...
            .addConstructor<void(*)(nx::env::GUICheckboxInfos const&)>()
            .addData("colorInfo", &nx::env::GUICheckboxInfos::colorInfo)
            .endClass()
            ...
            .addConstructor<void(*)(nx::env::GUIProgressBarInfos const&)>()
            .addData("colorInfo", &nx::env::GUIProgressBarInfos::colorInfo)
            .addData("textInfo", &nx::env::GUIProgressBarInfos::textInfo)
            .endClass()

            .beginClass<nx::env::GUIComboBoxInfos>("GUIComboBoxInfos")
            .addConstructor<void(*)(nx::env::ColorInfo const&, nx::env::TextInfo const&)>()
            .addConstructor<void(*)(nx::env::GUIComboBoxInfos const&)>()
            .addData("colorInfo", &nx::env::GUIComboBoxInfos::colorInfo)
            .addData("textInfo", &nx::env::GUIComboBoxInfos::textInfo)
            .endClass()

            .beginClass<nx::env::GUITextInputInfos>("GUITextInputInfos")
            .addConstructor<void(*)(nx::env::ColorInfo const&, nx::env::TextInfo const&)>()
            .addConstructor<void(*)(nx::env::GUITextInputInfos const&)>()
            .addData("colorInfo", &nx::env::GUITextInputInfos::colorInfo)
            .addData("textInfo", &nx::env::GUITextInputInfos::textInfo)
            .endClass()

            .beginClass<nx::env::GUITextInfos>("GUITextInfos")
            .addConstructor<void(*)(nx::env::TextInfo const&)>()
            //.addConstructor<void(*)(nx::env::GUITextInfos const&)>()
            .addData("textInfo", &nx::env::GUITextInfos::textInfo)
            .addFunction("getTextInfo", &nx::env::GUITextInfos::getTextInfo)
            .endClass()

            .beginClass<nx::env::GUIImageInfos>("GUIImageInfos")
            .addConstructor<void(*)(std::string const&)>()
            .addConstructor<void(*)(nx::env::GUIImageInfos const&)>()
            .addData("imagePath", &nx::env::GUIImageInfos::imagePath)
            .endClass()
            ...
            .addConstructor<void(*)(nx::env::GUISpriteInfos const&)>()
            .addData("spritesheetPath", &nx::env::GUISpriteInfos::spritesheetPath)
            .addData("sheetGrid", &nx::env::GUISpriteInfos::sheetGrid)
            .addData("spriteSize", &nx::env::GUISpriteInfos::spriteSize)
            .endClass()
            ...
            .addFunction("getGUITextInfo", &nx::env::gui::Text::getTextInfo)
            .addFunction("getGUIElementInfo", &nx::env::gui::Text::getElementInfo)
            .endClass()
