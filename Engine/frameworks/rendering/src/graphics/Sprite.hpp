#ifndef NX_GRAPHICS_SPRITE_HPP_
# define NX_GRAPHICS_SPRITE_HPP_
...
namespace nx
{
	namespace graphics
	{
		class Sprite : public GraphicsElement
		{
		...
		public:
			Sprite(sf::Vector2f const& pos, sf::Vector2f const& size, std::string const& identifier,
